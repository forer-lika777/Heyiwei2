...
还是那句话：如果你玩腻了 C++/WinUI，那你一定要去玩玩 WinUI/C++。玩 WinUI/C++ 开局你一定要写 IDL 文件，但是用 Microsoft Learn 是写不了 IDL 文件的，所以我们直接叫 deepseek 帮我们生成。

...诶？居然刷新 ”::“ 前面的一定是命名空间或类型名了，被做局了。如果是普通人玩 WinUI/C++ 遇到 ”::“ 前面的一定是命名空间或类型名他肯定投降了，但是我不会。我教你们一招：直接掏出你最难蹦的图片蹦他一手，他肯定蹦不住。
