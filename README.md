...
玩 WinUI/C++ 开局你一定要写 IDL 文件，但是用 Microsoft Learn 你是写不了 IDL 文件的，所以我们直接拿 Visual Studio 写。

...诶？居然刷新 ”::“ 前面的一定是命名空间或类型名了，被做局了。

如果是普通人玩 WinUI/C++ 遇到 ”::“ 前面的一定是命名空间或类型名他肯定投降了，但是我不会。我教你们一招：直接掏出 deepseek 蹦他一手，他肯定蹦不住。
...
我去，IDL，居然还是个 WinUI 内置的属性，错怪他了。

这里有本书，来看一下。WinUI 的配置指南，这是啥意思？
